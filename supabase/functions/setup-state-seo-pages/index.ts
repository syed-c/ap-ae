      ...
      try {
        const { error } = await supabaseAdmin
          ...
          .upsert({
            ...
            meta_title: `Find Dentists in ${city.name}, ${state.abbreviation} | DubaiDentist.ae`,
            meta_description: `Discover top-rated dentists in ${city.name}, ${state.name}. Compare reviews, services, and book appointments online with DubaiDentist.ae.`,
        ...
        try {
          const { error } = await supabaseAdmin
            ...
            .upsert({
              ...
              meta_title: `${treatment.name} Dentists in ${city.name}, ${state.abbreviation} | DubaiDentist.ae`,
              meta_description: `Find dentists offering ${treatment.name} in ${city.name}, ${state.name}. Compare providers, read reviews, and book appointments on DubaiDentist.ae.`,
